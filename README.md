# Problem-Solving Practice Packs
...
1. Pick the pack that matches the Practice callout you are working on (see table below).
2. Go to the [latest release](https://github.com/panaversity/problem-solving-practice-packs/releases/latest) and download just that pack's zip.
3. Unzip into a fresh folder, open the pack's `README.md`, and follow it.
